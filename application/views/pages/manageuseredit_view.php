...
<div class="col-lg-12">
        ...
        <div id="container">
            ...
            <td><input type="text" name="last_name"  required class="text" value="<?php //echo (isset($Users['last_name']))?$Users['last_name']:''; 
			echo ""; ?>"/>
            </td>
            </tr>
            ...
            <td><input type="text" name="first_name"  required class="text" value="<?php //echo (isset($Users['first_name']))?$Users['first_name']:''; 
			echo ""; ?>"/>
            </td>
            </tr>
