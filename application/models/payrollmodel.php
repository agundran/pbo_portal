...
class Payrollmodel extends CI_Model{
	...
	function get_processed_payroll($limit, $offset, $order_column, $order_type, $emp_no){
		...
		//else{
			...
			$query = $this->db->select( '*')
                            ...
                            ->where('payroll_runs_details.employee_no', $emp_no)
                            
							->order_by('payroll_runs.payr_id', 'ASC')
							//;
							->get('', $limit, $offset); 
